...
<style>
html.light .app-shell::before,
html:not(.dark) .app-shell::before {
  content: '';
  position: fixed;
  inset: 0;
  pointer-events: none;
  z-index: -2;
  background:
    linear-gradient(180deg, rgba(4, 12, 24, 0.26), rgba(4, 12, 24, 0.08) 34%, rgba(4, 12, 24, 0.34) 100%),
    radial-gradient(circle at 50% 100%, rgba(255, 210, 158, 0.24), transparent 26%),
    url('../assets/login/sky.png');
